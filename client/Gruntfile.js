module.exports = function(grunt) {
  ...
  var taskConfig = {
    ...
    delta: {
      ...
      jssrc: {
        ...
        tasks: [ 'jshint:src', 'karma:continuous', 'copy:buildAppjs' ]
      },
      ...
      coffeesrc: {
        ...
        tasks: [ 'coffeelint:src', 'coffee:source', 'karma:continuous', 'copy:buildAppjs' ]
      },
  ...
  grunt.registerTask('build', [
    ...
    'copy:buildAssets', 'copy:buildAppjs', 'copy:buildVendorjs',
  ...
  grunt.registerTask('compile', [
    'recess:compile', 'copy:compileAssets', 'ngmin', 'concat', 'uglify', 'index:compile'
  ]);
